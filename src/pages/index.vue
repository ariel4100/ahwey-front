		...
		<div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
			...
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				<h1 data-aos="fade-right" data-aos-once="true" class="my-4 text-5xl font-bold leading-tight text-white">
					<span class="text-yellow-500">Estudiar</span> Online ahora es mucho más fácil
				</h1>
				<p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="leading-normal text-2xl mb-8 text-white">Ahwey es una plataforma interesante que te enseñará de una forma más interactiva</p>
				<div data-aos="fade-up" data-aos-once="true" data-aos-delay="700" class="w-full md:flex items-center justify-center lg:justify-start md:space-x-5">
					...
					<div class="flex items-center justify-center space-x-3 mt-5 md:mt-0 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out">
						...
						<span class="cursor-pointer text-white">Mira cómo funciona</span>
					</div>
				</div>
			</div>
			<!--Right Col-->
			<div class="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
				<img data-aos="fade-up" data-aos-once="true" class="w-10/12 mx-auto 2xl:-mb-20" src="https://mhaecal.github.io/frontend/img/girl.png" /> 
				<!-- calendar -->
				<div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="absolute top-20 -left-6 sm:top-32 sm:left-10 md:top-40 md:left-16 lg:-left-0 lg:top-52 floating-4">
					<img class="rounded-lg h-12 sm:h-16" src="https://firebasestorage.googleapis.com/v0/b/clfargentina.appspot.com/o/ahwey%2Fhome%2Fpt.png?alt=media&token=7ca3cadd-6f05-4634-8556-f0b308d55ed3">
				</div>
				<!-- red -->
				...
				<div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="absolute bottom-14 -left-4 sm:left-2 sm:bottom-20 lg:bottom-24 lg:-left-4 floating">
					<img class="rounded-lg h-20 sm:h-28" src="https://firebasestorage.googleapis.com/v0/b/clfargentina.appspot.com/o/ahwey%2Fhome%2F36938bbe277961386e7e309dcb30cbd8.spain.svg?alt=media&token=12af5df3-ca59-4c38-913b-988ab3655797" alt="">
					<!-- <img class="rounded-lg h-20 sm:h-28" src="https://ahwey.com/uploads/flags/korean.png" alt=""> -->
				</div>
				<!-- congrats -->
				<div data-aos="fade-up" data-aos-delay="600" data-aos-once="true" class="absolute bottom-20 md:bottom-48 lg:bottom-52 -right-6 lg:right-8 floating-4">
					<img class="rounded-lg h-12 sm:h-16" src="https://firebasestorage.googleapis.com/v0/b/clfargentina.appspot.com/o/ahwey%2Fhome%2Fkorean.png?alt=media&token=16cc5098-4470-4003-9619-dc6fdf3d1f0d" alt="">
				</div>
			</div>
		</div>
	...
	<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
		...
		<!-- <div class="max-w-4xl mx-auto">
			...
			<div class="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
				<img class="h-7" src="https://mhaecal.github.io/frontend/img/company/google.svg">
				<img class="h-7" src="https://mhaecal.github.io/frontend/img/company/netflix.svg">
				<img class="h-7" src="https://mhaecal.github.io/frontend/img/company/airbnb.svg">
				<img class="h-7 transform translate-y-2" src="https://mhaecal.github.io/frontend/img/company/amazon.svg">
				<img class="h-7" src="https://mhaecal.github.io/frontend/img/company/facebook.svg">
				<img class="h-7" src="https://mhaecal.github.io/frontend/img/company/grab.svg">
			</div>
		</div> -->

		<!-- All-In-One Cloud Software. -->
		<div v-if="0" data-aos="flip-up" class="max-w-xl mx-auto text-center mt-20">
		...
		<!-- card -->
		<div v-if="0" class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
		...
		<div class="mt-28">
			<div data-aos="flip-down" class="text-center max-w-screen-md mx-auto">
				<h1 class="text-3xl font-bold mb-4">¿Que es <span class="text-yellow-500">Ahwey?</span></h1>
				<p class="text-gray-500 dark:text-white">
          Ahwey surgió con la misión de cumplir el sueño que tienen las personas de hablar un nuevo idioma para viajar, conocer otras culturas, hacer amistades con extranjeros y conectarlos con las oportunidades que el mundo tiene para ofrecerles.
        </p>
        <!-- <p class="text-gray-500 dark:text-white">
          Es con ese objetivo que Ahwey ofrece cursos de idiomas enfocados en hacer que el estudiante hable un nuevo idioma en el menor tiempo posible y a su vez que converse con nativos de otros países y establezca amistades con otros estudiantes alrededor del mundo.
        </p> -->
			...
			<div data-aos="fade-up" class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
				<div class="relative md:w-5/12">
					<img class="rounded-2xl" src="https://mhaecal.github.io/frontend/img/Rectangle 19.png" alt="">
					<div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
						<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
							<h1 class="uppercase text-white font-bold text-center text-sm lg:text-xl mb-3">PARA INSTRUCTORES</h1>
				...
				<div class="relative md:w-5/12">
					<img class="rounded-2xl" src="https://mhaecal.github.io/frontend/img/Rectangle 21.png" alt="">
					<div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
						<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
							<h1 class="uppercase text-white font-bold text-center text-sm lg:text-xl mb-3">PARA ESTUDIANTES</h1>
		...
		<div class="sm:flex items-center sm:space-x-8 mt-36">
			...
			<div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
				...
				<img class="rounded-xl z-40 relative" src="https://mhaecal.github.io/frontend/img/teacher-explaining.png" alt="">
		...
		<div class="md:flex mt-40 md:space-x-10 items-start">
			<div data-aos="fade-down" class="md:w-7/12 relative">
				...
				<img class="relative z-50 floating" src="https://mhaecal.github.io/frontend/img/vcall.png" alt="">
		...
		<div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
			...
			<img data-aos="fade-left" class="md:w-1/2" src="https://mhaecal.github.io/frontend/img/girl-with-books.png">
		</div>

		<!-- Assessments, Quizzes, Tests -->
		<div class="mt-20 flex flex-col-reverse md:flex-row items-center md:space-x-10">
			<div data-aos="fade-right" class="md:w-6/12">
				<img class="md:w-11/12" src="https://mhaecal.github.io/frontend/img/true-false.png">
			</div>
		...
		<div class="flex flex-col md:flex-row items-center mt-12">
			...
			<img data-aos="fade-left" class="md:w-7/12" src="https://mhaecal.github.io/frontend/img/gradebook.png">
		</div>

		<!-- One-on-One Discussions -->
		<div class="mt-24 flex flex-col-reverse md:flex-row items-center md:space-x-10">
			<div data-aos="fade-right" class="md:w-7/12">
				<img class="md:w-11/12" src="https://mhaecal.github.io/frontend/img/discussion.png">
			</div>
		...
		<div class="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
			<div data-aos="zoom-in-right" class="md:w-6/12">
				<img class="md:w-8/12 mx-auto" src="https://mhaecal.github.io/frontend/img/integrations.png">
			</div>
		...
		<div class="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
			...
			<div data-aos="zoom-in-left" class="md:w-7/12">
				<img class="md:w-10/12 mx-auto" src="https://mhaecal.github.io/frontend/img/testimonials.png">
			</div>
		</div>
		...
		<div data-aos="zoom-in-up" class="my-14 flex flex-col lg:flex-row lg:space-x-20">
			<div class="lg:w-6/12">
				<img class="w-full mb-6" src="https://mhaecal.github.io/frontend/img/laptop-news.png">
			...
			<div class="lg:w-7/12 flex flex-col justify-between mt-12 space-y-5 lg:space-y-0 lg:mt-0">
				<div class="flex space-x-5">
					<div class="w-4/12">
						<div class="relative">
							<img class="rounded-xl w-full" src="https://mhaecal.github.io/frontend/img/children-laptop.png">
				...
				<div class="flex space-x-5">
					<div class="w-4/12">
						<div class="relative">
							<img class="rounded-xl w-full" src="https://mhaecal.github.io/frontend/img/girl-laptop.png">
				...
				<div class="flex space-x-5">
					<div class="w-4/12">
						<div class="relative">
							<img class="rounded-xl w-full" src="https://mhaecal.github.io/frontend/img/cat-laptop.png">
							<span class="absolute bottom-2 right-2 bg-yellow-300 text-darken font-semibold px-4 py-px text-sm rounded-full hidden sm:block">NEWS</span>
						</div>
					</div>
					<div class="w-8/12">
